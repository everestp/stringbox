...
const teamMembers = [
  {
    ...
    initials: "DG",
    social: {
      linkedin: "https://www.linkedin.com/in/deepak-gautam-496740230/",
  ...
  },
  {
    ...
    initials: "EP",
    social: {
      linkedin: "https://linkedin.com/in/everestp",
    },
  },
  {
    name: "Nitik Sunam",
...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black text-gray-900 dark:text-gray-100">
      <Navbar />
        ...
        <div className="container mx-auto px-6 py-20 md:py-28">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-10 max-w-7xl mx-auto">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="group relative bg-white dark:bg-gray-900 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 overflow-hidden border border-gray-100 dark:border-gray-700"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative p-8">
                  ...
                  <div className="relative mb-6">
                    <div className="relative h-32 w-32 mx-auto transform transition-transform duration-500 group-hover:scale-110">
                      <img
                        src={member.image}
                        alt={member.name}
                        className="h-full w-full rounded-full object-cover border-4 border-white dark:border-gray-800 shadow-lg"
                        onError={(e) => {
                      ...
                      />
                      <div className="hidden h-full w-full rounded-full bg-gradient-to-br from-blue-500 to-purple-500 text-3xl font-bold items-center justify-center text-white shadow-lg dark:shadow-md">
                        {member.initials}
                      </div>
                      <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-gradient-to-br from-green-400 to-blue-500 rounded-full border-4 border-white dark:border-gray-900" />
                    </div>
                  </div>
                  ...
                  <div className="text-center space-y-4">
                    <div>
                      ...
                      <p className="text-blue-600 dark:text-blue-400 font-semibold text-lg mb-4">{member.position}</p>
                    </div>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-sm">{member.bio}</p>
                    ...
                    <div className="pt-6 flex justify-center gap-4">
                      {member.social?.linkedin && (
                        <a
                          ...
                          className="p-3 bg-gray-100 dark:bg-gray-800 hover:bg-blue-500 rounded-full transition-all duration-300 hover:text-white"
                        >
                      ...
                      {member.social?.twitter && (
                        <a
                          ...
                          className="p-3 bg-gray-100 dark:bg-gray-800 hover:bg-blue-400 rounded-full transition-all duration-300 hover:text-white"
                        >
                          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
