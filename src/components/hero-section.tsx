  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-32">
      ...
      <div className="container relative z-10">
        <div
          className={`mx-auto max-w-3xl text-center transition-transform duration-1000 ease-out ${
          ...
          {false && (
            <div className="mt-12">
              ...
              <div className="flex flex-wrap justify-center gap-8">
                <div className="text-xl font-semibold text-muted-foreground/60">company 1</div>
                <div className="text-xl font-semibold text-muted-foreground/60">company 2</div>
                <div className="text-xl font-semibold text-muted-foreground/60">company 3</div>
                <div className="text-xl font-semibold text-muted-foreground/60">company 4</div>
              </div>
            </div>
          )}
        </div>
